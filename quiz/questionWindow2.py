...
from quiz.questionWindow3 import questionThree
...
class questionTwo:
    def __init__(self, root, 
        ...
        self.question_label.grid(row=1, column=0, columnspan=3,  pady=0, padx=0, sticky="nsew")

        # Create the buttons
        self.b1 = tk.Button(self.root, text=a, command=self.wrong_answer)
        self.b1.grid(row=2, column=0, padx=10, pady=10)

        self.b2 = tk.Button(self.root, text=b, command=self.right_answer)
    ...
    def button_click(self):
        ...
        next_window = questionThree(root, 
                                      "What's the highest note \n that a standard concert flute can play?",
                                      "Music",
                                      "C6",
                                      "C7",
                                      "C8")
