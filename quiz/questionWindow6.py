...
from quiz.questionWindow7 import questionSeven
...
class questionSix:
    def __init__(self, root, 
        ...
        self.b3 = tk.Button(self.root, text=b, command=self.right_answer)
    ...
    def button_click(self):
        ...
        next_window = questionSeven(root, 
                                      "What's Enno's favorite?",
                                      "Food",
                                      "Milk Tuc",
                                      "Milka plain",
                                      "Milka Hazelnut")
